...
**
** Created: Fri 9. Feb 18:25:10 2024
...
public:
    ...
    void setupUi(QDialog *Smart_Process_Dlg)
    {
        ...
        Smart_Process_Dlg->resize(296, 224);
        ...
        scrollAreaWidgetContents->setGeometry(QRect(0, 0, 244, 74));
    ...
    {
        Smart_Process_Dlg->setWindowTitle(QApplication::translate("Smart_Process_Dlg", "Form", 0, QApplication::UnicodeUTF8));
        lbl_header->setText(QString());
        lbl_text1->setText(QString());
        lbl_text2->setText(QString());
