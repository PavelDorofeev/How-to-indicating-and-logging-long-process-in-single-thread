...
static const char qt_meta_stringdata_QpSingleShotTimer[] = {
    ...
    "invokeMethod_slot_byName_withPars(QObject*,QString,QList<QVariant>,QVa"
    "riant&)\0"
};
...
void QpSingleShotTimer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: { bool _r = _t->invokeMethod_slot_byName_withPars((*reinterpret_cast< QObject*(*)>(_a[1])),(*reinterpret_cast< const QString(*)>(_a[2])),(*reinterpret_cast< const QList<QVariant>(*)>(_a[3])),(*reinterpret_cast< QVariant(*)>(_a[4])));
